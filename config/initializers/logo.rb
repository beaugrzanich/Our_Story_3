# This setting determines the target height (in pixels) that `app/assets/images/logo/logo.png` will be resized to
# (while maintaining aspect ratio) when being presented in the `box` component header or the header of outgoing emails.
...
BulletTrain::Themes.logo_height = 108
